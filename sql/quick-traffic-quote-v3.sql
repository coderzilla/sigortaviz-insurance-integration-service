...
(@fieldSetId,'insurerEmail','Sigorta Ettiren E-posta',NULL,'email',1,1,1,'ornek@mail.com',NULL,NULL,120,NULL,NULL,NULL,NULL,JSON_ARRAY('quote','personal'),NULL,NULL),
(@fieldSetId,'insurerBirthDate','Sigorta Ettiren Doğum Tarihi',NULL,'date',1,1,2,'YYYY-AA-GG',NULL,NULL,NULL,NULL,NULL,NULL,NULL,JSON_ARRAY('quote','personal'),NULL,NULL),
