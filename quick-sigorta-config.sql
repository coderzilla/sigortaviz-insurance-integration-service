...
(@trafficFieldSetId, 'insurerIdNumber', 'Sigorta Ettiren TCKN / VKN', NULL, 'identity', 1, 1,
  1, '11 haneli TCKN', '^[0-9]{11}$', 11, 11, NULL, NULL, NULL, NULL, JSON_ARRAY('quote','basic','auth'), NULL, NULL),
(@trafficFieldSetId, 'insurerPhoneNumber', 'Sigorta Ettiren Telefon', NULL, 'phone', 1, 1,
  2, '5xxxxxxxxx', NULL, 10, 20, NULL, NULL, NULL, NULL, JSON_ARRAY('quote','basic','auth'), NULL, NULL),
(@trafficFieldSetId, 'securityCode', 'Güvenlik Kodu', 'Kayıtlı değilse doğrulama kodu', 'text', 0, 1,
  1, 'XXXXXX', NULL, 4, 8, NULL, NULL, NULL, NULL, JSON_ARRAY('quote','basic','security'), NULL, NULL),
(@trafficFieldSetId, 'occupationCode', 'Meslek Seç', NULL, 'select', 1, 1,
...
(@trafficFieldSetId, 'insurerBirthDate', 'Sigorta Ettiren Doğum Tarihi', NULL, 'date', 1, 1,
  1, 'YYYY-AA-GG', NULL, NULL, NULL, NULL, NULL, NULL, NULL, JSON_ARRAY('quote','personal'), NULL, NULL),
(@trafficFieldSetId, 'insurerEmail', 'Sigorta Ettiren E-posta', NULL, 'email', 1, 1,
  2, 'ornek@mail.com', NULL, NULL, 120, NULL, NULL, NULL, NULL, JSON_ARRAY('quote','personal'), NULL, NULL),
(@trafficFieldSetId, 'insuredBirthDate', 'Sigortalı Doğum Tarihi', 'Boş bırakılırsa sigorta ettiren kullanılır.', 'date', 0, 0,
...
(@trafficFieldSetId, 'insuredEmail', 'Sigortalı E-posta', 'Boş bırakılırsa sigorta ettiren kullanılır.', 'email', 0, 0,
  4, 'ornek@mail.com', NULL, NULL, 120, NULL, NULL, NULL,
  JSON_OBJECT('autoPopulateFrom', 'insurerEmail'),
  JSON_ARRAY('quote','personal'), NULL, NULL),
(@trafficFieldSetId, 'insuredPhoneNumber', 'Sigortalı Telefon', 'Boş bırakılırsa sigorta ettiren kullanılır.', 'phone', 0, 0,
  5, '5xxxxxxxxx', NULL, 10, 20, NULL, NULL, NULL,
  JSON_OBJECT('autoPopulateFrom', 'insurerPhoneNumber'),
  JSON_ARRAY('quote','personal'), NULL, NULL),
(@trafficFieldSetId, 'insuredIdNumber', 'Sigortalı TCKN (farklıysa)', 'Boş bırakılırsa sigorta ettiren kullanılır.', 'identity', 0, 0,
  6, '11 haneli TCKN', '^[0-9]{11}$', 11, 11, NULL, NULL, NULL,
  JSON_OBJECT('autoPopulateFrom', 'insurerIdNumber'),
  JSON_ARRAY('quote','personal'), NULL, NULL),
(@trafficFieldSetId, 'packageType', 'Paket Tipi', NULL, 'select', 1, 1,
  1, NULL, NULL, NULL, NULL, NULL, NULL,
...
(@trafficFieldSetId, 'plateType', 'Plaka Tipi', NULL, 'select', 1, 1,
  1, NULL, NULL, NULL, NULL, NULL, NULL,
  JSON_ARRAY(
...
(@trafficFieldSetId, 'plateNumber', 'Plaka No', 'Tescilli senaryo için', 'text', 0, 1,
...
(@trafficFieldSetId, 'plateCityCode', 'Plaka İl Kodu', NULL, 'select', 0, 1,
  ...
  JSON_ARRAY('vehicle','license','page1'), NULL, NULL),
(@trafficFieldSetId, 'registrationSerialCode', 'Tescil Seri Kodu', NULL, 'text', 0, 1,
...
(@trafficFieldSetId, 'registrationSerialNumber', 'Tescil Seri No', NULL, 'text', 0, 1,
  ...
  JSON_ARRAY('vehicle','license','page2'), NULL, NULL),
(@trafficFieldSetId, 'usageStyle', 'Kullanım Tarzı', NULL, 'select', 0, 1,
  3, NULL, NULL, NULL, NULL, NULL, NULL,
  ...
  JSON_ARRAY('vehicle','license','page2'), NULL, NULL),
(@trafficFieldSetId, 'modelYear', 'Model Yılı', NULL, 'select', 0, 1,
  ...
  JSON_ARRAY('vehicle','license','page2'), NULL, NULL),
(@trafficFieldSetId, 'makeId', 'Marka', NULL, 'select', 0, 1,
  ...
  JSON_ARRAY('vehicle','license','page2'), NULL, NULL),
(@trafficFieldSetId, 'engineNumber', 'Motor No', NULL, 'text', 0, 1,
  ...
  JSON_ARRAY('vehicle','license','page2'), NULL, NULL),
(@trafficFieldSetId, 'chassisNumber', 'Şasi No', NULL, 'text', 0, 1,
  ...
  JSON_ARRAY('vehicle','license','page2'), NULL, NULL),
(@trafficFieldSetId, 'isDealer', 'Galerici Kısa Süreli', 'Dealer kısa süreli trafik (policyDuration 120)', 'boolean', 0, 1,
